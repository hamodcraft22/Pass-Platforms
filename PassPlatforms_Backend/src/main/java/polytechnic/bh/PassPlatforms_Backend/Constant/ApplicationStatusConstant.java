...
public final class ApplicationStatusConstant {
    ...
    public static final char APLC_ACCEPTED = 'a';
    public static final char APLC_REJECTED = 'n';
    public static final char APLC_CANCLED = 'p';
    public static final char APLC_REOPENED = 't';
}
