...
export default function SchedulePage()
{
    ...
    async function getSchedules(studentID)
    {
        try
        {
            ...
            await fetch(`${process.env.REACT_APP_BACKEND_URL}/api/schedule/student/${studentID}`, requestOptions)
                .then(response =>
                {
    ...
    async function submitMultiSchedule(scheduleToSubmit)
    {
        ...
        try
        {
            ...
            await fetch(`${process.env.REACT_APP_BACKEND_URL}/api/schedule/multi`, requestOptions)
                .then((response) =>
                {
    ...
    async function submitSchedule(scheduleToSubmit)
    {
        ...
        try
        {
            ...
            await fetch(`${process.env.REACT_APP_BACKEND_URL}/api/schedule`, requestOptions)
                .then((response) =>
                {
                    if (response.status === 201 || response.status === 200)
                    {
