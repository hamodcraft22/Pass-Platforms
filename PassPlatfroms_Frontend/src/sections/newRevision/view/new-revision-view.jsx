                ...
                shownSection===2 && <Card>
                    <div style={{padding: "15px"}} >
                        ...
                        <LocalizationProvider dateAdapter={AdapterMoment}>
                                <DatePicker sx={{ width: "100%", mt:1 }} label="Revision Date" minDate={revWeekStartDate} maxDate={revWeekEndDate} value={revWeekSelectedDate} onChange={(newValue) => {setRevWeekSelectedDate(newValue)}}/>
                        ...
                        <LocalizationProvider dateAdapter={AdapterMoment}>
                            <TimePicker sx={{ mt:1, mr: 1}} label="Start Time" minTime={revWeekStartTime} maxTime={revWeekEndTime} value={revWeekSelectedStartTime} onChange={(newValue) => {setRevWeekSelectedStartTime(newValue)}} />
                        </LocalizationProvider>
                        <LocalizationProvider dateAdapter={AdapterMoment}>
                            <TimePicker sx={{ mt:1, }} label="End Time" minTime={revWeekStartTime} maxTime={revWeekEndTime} value={revWeekSelectedEndTime} onChange={(newValue) => {setRevWeekSelectedEndTime(newValue)}} />
                        </LocalizationProvider>
            ...
            {/* group formation & online/physical card */}
            {
                shownSection===3 && <Card>
                    <div style={{padding: "15px"}}>
                        ...
                        <FormControl>
                            <RadioGroup row value={revisionType} onChange={(event, newValue) => {setRevisionType(newValue)}}>
                        ...
                        <TextField sx={{ width: '100%', mt:1}} label="Optinal - This Session will focuse on:" variant="outlined" multiline rows={4} value={revisionNote} onChange={(newValue) => setRevisionNote(newValue.target.value)}/>
            ...
            {/* overview and submit card */}
            {
                shownSection===4 && <Card>
                    <div style={{padding: "15px"}}>
                        ...
                        <TextField label="Date" variant="standard" fullWidth sx={{ mb: 1, mt:2 }} InputProps={{readOnly: true}} defaultValue={moment(revWeekSelectedDate).format("DD/MM/YYYY")}/>

                        <TextField label="From" variant="standard" sx={{ mb: 1, mt:1, mr: 1}} InputProps={{readOnly: true}} defaultValue={moment(revWeekSelectedStartTime).format("hh:mma")}/>
                        <TextField label="To" variant="standard" sx={{ mb: 1, mt:1, }} InputProps={{readOnly: true}} defaultValue={moment(revWeekSelectedEndTime).format("hh:mma")}/>

                        <TextField label="Session Type" variant="standard" fullWidth sx={{ mb: 1, mt:2 }} InputProps={{readOnly: true}} defaultValue={revisionType}/>

                        <TextField label="Area of help" variant="standard" fullWidth sx={{ mb: 1, mt:2 }} InputProps={{readOnly: true}} defaultValue={revisionNote} multiline maxRows={4}/>
                    </div>
                </Card>
            }
        </Container>
