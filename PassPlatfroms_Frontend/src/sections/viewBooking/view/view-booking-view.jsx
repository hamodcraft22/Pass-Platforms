...
export default function ViewBookingPage()
{
    ...
    async function getBooking()
    {
        try
        {
            ...
            await fetch(`https://backend.zift.ddnsfree.com/api/booking/${bookingIDParm}`, requestOptions)
                .then(response =>
                {
    ...
    async function submitUserNote()
    {
        try
        {
            ...
            await fetch(`https://backend.zift.ddnsfree.com/api/bookingnote/${bookingInfo.bookingid}`, requestOptions)
                .then(response =>
                {
