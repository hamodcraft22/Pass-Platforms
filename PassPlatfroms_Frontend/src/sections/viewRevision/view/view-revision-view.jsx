...
export default function ViewRevisionPage()
{
    ...
    async function getRevision()
    {
        try
        {
            ...
            await fetch(`https://backend.zift.ddnsfree.com/api/revision/${revisionIDParm}`, requestOptions)
                .then(response =>
                {
    ...
    async function submitUserNote()
    {
        try
        {
            ...
            await fetch(`https://backend.zift.ddnsfree.com/api/bookingnote/${revisionInfo.bookingid}`, requestOptions)
                .then(response =>
                {
